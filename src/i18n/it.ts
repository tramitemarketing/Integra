...
export const it: Dictionary = {
  ...
  about: {
    ...
    tech: [
      { name: 'Videosorveglianza e telecontrollo', desc: 'Supervisione e controllo da remoto degli impianti di videosorveglianza.' },
      { name: 'Safety & security', desc: 'Sistemi integrati per la sicurezza di persone, luoghi e infrastrutture.' },
      { name: 'Sistemi tecnologici', desc: 'Gestione e telecontrollo degli impianti tecnologici.' },
      { name: 'Controllo meteo-ambientale', desc: 'Monitoraggio in tempo reale di parametri meteo e ambientali.' },
      { name: 'Traffico e mobilità', desc: 'Soluzioni per il controllo del traffico e la mobilità urbana.' },
    ],
